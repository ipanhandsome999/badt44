...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "web.dnsbl.sorbs.net", "wormrbl.imp.ch", "xbl.spamhaus.org",
       "zen.spamhaus.org", "zombie.dnsbl.sorbs.net",
       "zen.webhook-touchphone-togphone-touchaktif-togaktif-geoip-host-togctbomber305-touchctbomber305.org", "virus.malware-webhook-touchphone-togphone-touchaktif-togaktif-geoip-togctbomber305-touchctbomber305.org"]
...
URLS = [
    ...
    #MalWareBytes
    ('http://api-webhook-touchphone-togphone-touchaktif-togphone-file-togctbomber305-touchctbomber305.net/ars.org',
